...
TRUSTED_DASHBOARD_PROVIDER_JSON_SCHEMA = {
    ...
    "$id": "https://canonical.github.io/charm-relation-interfaces/interfaces/trusted-dashboard/schemas/provider.json",
    "type": "object",
    "properties": {
        "dashboard-url": {
            "type": "string",
...
TRUSTED_DASHBOARD_REQUIRE_JSON_SCHEMA = {
    "$schema": "http://json-schema.org/draft-07/schema",
    "$id": "https://canonical.github.io/charm-relation-interfaces/interfaces/trusted-dashboard/schemas/requirer.json",
    "type": "object",
    "properties": {
        "federated-providers": {
            "type": "array",
