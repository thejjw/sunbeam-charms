...
class TestTemplating(test_utils.CharmTestCase):
    ...
    def test_render_context_defaults_to_service_behavior(self) -> None:
        ...
        render_context = handler.render_context({"debug": True})

        self.assertTrue(render_context["debug"])
        self.assertFalse(
            render_context["service_template"].heartbeat_in_pthread
        )
    ...
    def test_render_context_enables_wsgi_behavior(self) -> None:
        ...
        render_context = handler.render_context({})
