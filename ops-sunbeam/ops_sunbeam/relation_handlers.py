...
class DBHandler(RelationHandler):
    ...
    def update_relation_data(self):
        """Update relation outside of relation context."""
        self.publish_encoded_fields()

    def publish_encoded_fields(self):
        ...
        set_encoded_field(
            ...
            self.charm.app,
            REQ_SECRET_FIELDS,
            # This is a list that will updating if we ever ask for more
            # secret fields than defaults
            DatabaseRequires.SECRET_FIELDS,
        )
