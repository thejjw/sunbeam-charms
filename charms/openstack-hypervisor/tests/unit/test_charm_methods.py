...
class TestMicroOVNConfiguration:
    ...
    def test_ovsdb_cms_departure_clears_ovn_tls_settings(self, charm_instance):
        """ovsdb-cms departure removes OVN TLS material from the snap."""
        charm_instance.set_snap_data = MagicMock()

        charm_instance.stop_services({"ovsdb-cms"})
