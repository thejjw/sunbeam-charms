...
class HypervisorOperatorCharm(sunbeam_charm.OSBaseOperatorCharm):
    ...
    def __init__(self, framework: ops.framework.Framework) -> None:
        ...
        self.consul_notify = ConsulNotifyProvider(self, "consul-notify")
        self.framework.observe(
    ...
    def _on_notify_parameter_request(self, event: ops.framework.EventBase):
        """Handle the notify parameter request event.

        This event happens when a client charm relates to this charm
        and requests notification parameters.
        """
        logger.debug("Handling notify parameter request event")
        snap_name = "snap-openstack-hypervisor"
        unix_socket_filepath = "data/shutdown.sock"
