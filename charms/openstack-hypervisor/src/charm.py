...
class HypervisorOperatorCharm(sunbeam_charm.OSBaseOperatorCharm):
    ...
    def _get_dpdk_settings_override(self) -> dict:
        ...
        # If set, those will override the charm settings.
        #
    ...
    def _handle_ovs_dpdk(
        ...
        total_numa_node_count = len(numa_architecture)
        ...
        if total_memory_mb:
            ...
            dpdk_numa_memory = []
            for numa_node in range(total_numa_node_count):
        ...
        # TODO: clean unused allocations from other nodes.
