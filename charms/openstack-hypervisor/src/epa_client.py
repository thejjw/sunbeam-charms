...
class EPAClient:
    ...
    def allocate_cores(
        ...
        if numa_node is not None:
            ...
            # TODO: drop the following line if/when the "alocate_cores" API gets consolidated
            # and we no longer need a separate action for numa aware allocations.
            request["action"] = "explicitly_allocate_numa_cores"
