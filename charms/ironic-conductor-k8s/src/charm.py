    ...
    def get_layer(self) -> dict:
        ...
        return {
            ...
            "services": {
                ...
                f"{self.wsgi_service_name}": wsgi_layer["services"][f"{self.wsgi_service_name}"]
            },
        }
...
class IronicConductorOperatorCharm(sunbeam_charm.OSBaseOperatorCharmK8S):
    ...
    def __init__(self, framework: ops.framework.Framework) -> None:
        ...
        service_ports = [
            core_v1.ServicePort(
                IRONIC_CONDUCTOR_HTTP_PORT, appProtocol="http", name="http", protocol="TCP"
            ),
            core_v1.ServicePort(
                IRONIC_CONDUCTOR_TFTP_PORT, appProtocol="tftp", name="tftp", protocol="UDP"
            ),
        ]
        ...
        self.unit.set_ports(IRONIC_CONDUCTOR_HTTP_PORT, IRONIC_CONDUCTOR_TFTP_PORT)
