...
To deploy the local test instance:
    ...
    juju deploy ./manila-k8s.charm manila --trust \
      --resource manila-api-image=ghcr.io/canonical/manila-api:2026.2-26.04_edge \
      --resource manila-scheduler-image=ghcr.io/canonical/manila-scheduler:2026.2-26.04_edge
