...
from utils.cleanup import (
    ...
    _get_filtered_test_projects_in_domain,
...
class TestCleanup(unittest.TestCase):
    ...
    def test_get_filtered_test_projects_in_domain_with_exclusion(self):
        ...
        projects = _get_filtered_test_projects_in_domain(
    ...
    @patch("utils.cleanup._get_filtered_test_projects_in_domain")
    @patch("utils.cleanup._get_exclusion_resources")
    def test_run_quick_cleanup(
        self,
        mock_get_exclusion_resources,
        mock_get_filtered_test_projects_in_domain,
        ...
        mock_get_filtered_test_projects_in_domain.return_value = [
            "tempest_project_id"
        ]
    ...
    @patch("utils.cleanup._get_filtered_test_projects_in_domain")
    @patch("utils.cleanup._get_exclusion_resources")
    def test_run_quick_cleanup_filtered(
        self,
        mock_get_exclusion_resources,
        mock_get_filtered_test_projects_in_domain,
        mock_get_test_projects_in_domain,
        ...
        mock_cleanup_networks_resources.assert_not_called()
        mock_cleanup_project.assert_not_called()
    ...
    def test_run_quick_cleanup_error(
        ...
        mock_get_filtered_test_projects_in_domain.assert_not_called()
        mock_cleanup_stacks.assert_not_called()
        mock_cleanup_images.assert_not_called()
        mock_cleanup_block_resources.assert_not_called()
        mock_cleanup_compute_resources.assert_not_called()
        mock_cleanup_networks_resources.assert_not_called()
        mock_cleanup_project.assert_not_called()
    ...
    @patch("utils.cleanup._get_filtered_test_projects_in_domain")
    @patch("utils.cleanup._get_exclusion_resources")
    def test_run_quick_cleanup_unsuccessful(
        self,
        mock_get_exclusion_resources,
        mock_get_filtered_test_projects_in_domain,
        mock_get_test_projects_in_domain,
        ...
        """Test run quick cleanup with one test resulted in error."""
        env = MagicMock()
        mock_get_test_projects_in_domain.return_value = ["tempest_project_id"]
        mock_get_filtered_test_projects_in_domain.return_value = [
            "tempest_project_id"
        ...
        self.assertIn("_cleanup_images", str(error.exception))

        # Check if all cleanup funcs are call despite one of them failed
        mock_connect_to_os.assert_called_once_with(env)
        mock_get_exclusion_resources.assert_called_once()
        mock_get_test_projects_in_domain.assert_called_once()
        mock_cleanup_stacks.assert_called_once()
    ...
    @patch("utils.cleanup._connect_to_os")
    @patch("utils.cleanup._get_test_projects_in_domain")
    def test_run_extensive_cleanup_unsuccessful(
        self,
        mock_get_test_projects_in_domain,
        mock_connect_to_os,
        mock_cleanup_users,
        ...
        """Test run extensive cleanup with one of the test executed unsuccessfully."""
        env = MagicMock()
        mock_get_test_projects_in_domain.return_value = ["tempest_project_id"]
        mock_cleanup_compute_resources.__name__ = "_cleanup_compute_resources"
        mock_cleanup_compute_resources.side_effect = Exception

        with self.assertRaises(CleanUpError) as error:
            run_extensive_cleanup(env)

        self.assertIn("_cleanup_compute_resources", str(error.exception))
