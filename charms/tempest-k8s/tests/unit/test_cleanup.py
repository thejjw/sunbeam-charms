...
class TestCleanup(unittest.TestCase):
    ...
    def test_cleanup_projects(self):
        """Test cleanup projects."""
        project_id = "tempest_project_id"

        _cleanup_projects(self.mock_connection, project_id)
    ...
    def test_run_extensive_cleanup(
        ...
        env = MagicMock()
        mock_get_test_projects_in_domain.return_value = ["tempest_project_id"]
        mock_cleanup_projects.__name__ = "_cleanup_projects"
        mock_cleanup_networks_resources.__name__ = (
            "_cleanup_networks_resources"
        )
        mock_cleanup_stacks.__name__ = "_cleanup_stacks"
        mock_cleanup_images.__name__ = "_cleanup_images"
        mock_cleanup_block_resources.__name__ = "_cleanup_block_resources"
