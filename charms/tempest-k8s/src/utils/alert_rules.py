...
def update_alert_rules_files(schedule: Schedule) -> None:
    ...
    absent_range_hours = min(
        ...
        int(schedule.max_interval / 60 / 60) * 2,
        ...
        "groups": [
            {
                ...
                "rules": [
                    ...
                    {
                        "alert": "AbsentTests",
                        "expr": f'absent_over_time({{filename="/var/lib/tempest/workspace/tempest-periodic.log", %%juju_topology%%}} |~ "- Failed:" [{absent_range_hours}]) == 1',
                        "labels": {
                            "severity": "high",
                        },
                        "annotations": {
