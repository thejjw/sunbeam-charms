...
def _get_test_projects_in_domain(conn, domain_id, prefix="tempest-"):
...
def _cleanup_stacks(conn, project_id, prefix="tempest-"):
...
def run_quick_cleanup(env, prefix="tempest-"):
...
def run_extensive_cleanup(env, prefix="tempest-"):
