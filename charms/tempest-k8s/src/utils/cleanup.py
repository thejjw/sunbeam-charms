...
def _get_test_projects_in_domain(conn: Connection, domain_id: str) -> list[str]:
...
def _get_filtered_test_projects_in_domain(
    conn: Connection, domain_id: str, exclude_projects: set[str] = set()
) -> list[str]:
    """Get filtered test projects with names starting with prefix in the specified domain.
...
def run_quick_cleanup(env: dict) -> None:
    ...
    try:
        ...
        filtered_test_projects = _get_filtered_test_projects_in_domain(
