...
class TestCinderOperatorCharm(test_utils.CharmTestCase):
    ...
    def test_cinder_conf_contains_os_region_name(self):
        """Test cinder.conf includes os_region_name from config."""
        ...
        self.assertIn("os_region_name = RegionOne", received_data)
