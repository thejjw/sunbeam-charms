...
"""Shared fixtures for openstack-images-sync-k8s unit tests."""
...
@pytest.fixture()
def ctx():
    """Create a testing.Context for OpenstackImagesSyncK8SCharm."""
    return testing.Context(
        charm.OpenstackImagesSyncK8SCharm, charm_root=CHARM_ROOT
    )
...
def complete_secrets():
    ...
    return [identity_service_secret()]


@pytest.fixture()
def container():
    """A connectable openstack-images-sync container with exec mocks."""
