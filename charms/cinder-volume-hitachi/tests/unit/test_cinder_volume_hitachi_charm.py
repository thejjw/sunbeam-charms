...
class _CinderVolumeHitachiOperatorCharm(charm.CinderVolumeHitachiOperatorCharm):
...
class TestCinderVolumeHitachiOperatorCharm(test_utils.CharmTestCase):
    ...
    def test_backend_configuration_pushed_to_snap(self):
        ...
        self.snap.SnapCache.return_value = {"cinder-volume": cinder_volume_snap_mock}
        ...
        expected_settings = {
            "hitachi.cinder-volume-hitachi": {
                ...
                "san_login": "svcuser",
                "san_password": "secret",
                "hitachi_storage_id": "45000",
                "hitachi_pools": "DP_POOL_01",
                # Defaulted fields should *not* appear
            }
        }
        # Verify that the snap received the config with typed=True
        cinder_volume_snap_mock.set.assert_any_call(expected_settings, typed=True)
