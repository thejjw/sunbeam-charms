...
"""Cinder hpexp Operator Charm.

This charm provide Cinder <-> hpexp integration as part
...
class CinderVolumeHpexpOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/HPE XP Operator charm."""

    service_name = "cinder-volume-hpexp"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for HPE XP."""
        return "hpexp." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeHpexpOperatorCharm)
