...
"""Unit tests for Cinder hpexp operator charm."""
...
class _CinderVolumeHpexpOperatorCharm(charm.CinderVolumeHpexpOperatorCharm):
...
class TestCinderHpexpOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeHpexpOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeHpexpOperatorCharm,
            "_import_snap",
