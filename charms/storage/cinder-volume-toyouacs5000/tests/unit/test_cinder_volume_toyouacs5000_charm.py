...
"""Unit tests for Cinder toyouacs5000 operator charm."""
...
class _CinderVolumeToyouacs5000OperatorCharm(charm.CinderVolumeToyouacs5000OperatorCharm):
...
class TestCinderToyouacs5000OperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeToyouacs5000OperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeToyouacs5000OperatorCharm,
            "_import_snap",
