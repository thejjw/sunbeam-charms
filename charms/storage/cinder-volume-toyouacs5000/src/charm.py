...
"""Cinder toyouacs5000 Operator Charm.

This charm provide Cinder <-> toyouacs5000 integration as part
...
class CinderVolumeToyouacs5000OperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Toyouacs5000 Operator charm."""

    service_name = "cinder-volume-toyouacs5000"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for Toyou ACS5000."""
        return "toyouacs5000." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeToyouacs5000OperatorCharm)
