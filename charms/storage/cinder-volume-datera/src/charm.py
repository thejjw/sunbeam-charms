...
"""Cinder datera Operator Charm.

This charm provide Cinder <-> datera integration as part
...
class CinderVolumeDateraOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Datera Operator charm."""

    service_name = "cinder-volume-datera"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for Datera."""
        return "datera." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeDateraOperatorCharm)
