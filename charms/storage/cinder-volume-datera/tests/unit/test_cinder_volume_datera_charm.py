...
"""Unit tests for Cinder datera operator charm."""
...
class _CinderVolumeDateraOperatorCharm(charm.CinderVolumeDateraOperatorCharm):
...
class TestCinderDateraOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeDateraOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeDateraOperatorCharm,
            "_import_snap",
