...
"""Unit tests for Cinder QNAP operator charm."""
...
class _CinderVolumeQnapOperatorCharm(charm.CinderVolumeQnapOperatorCharm):
...
class TestCinderQnapOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeQnapOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeQnapOperatorCharm,
            "_import_snap",
