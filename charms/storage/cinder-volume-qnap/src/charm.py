...
"""Cinder QNAP Operator Charm.

This charm provide Cinder <-> QNAP integration as part
...
class CinderVolumeQnapOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/QNAP Operator charm."""

    service_name = "cinder-volume-qnap"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for QNAP."""
        return "qnap." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeQnapOperatorCharm)
