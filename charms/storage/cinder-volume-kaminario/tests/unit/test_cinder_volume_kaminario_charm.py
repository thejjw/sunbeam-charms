...
"""Unit tests for Cinder kaminario operator charm."""
...
class _CinderVolumeKaminarioOperatorCharm(charm.CinderVolumeKaminarioOperatorCharm):
...
class TestCinderKaminarioOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeKaminarioOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeKaminarioOperatorCharm,
            "_import_snap",
