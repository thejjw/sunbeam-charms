...
"""Cinder ibmgpfs Operator Charm.

This charm provide Cinder <-> ibmgpfs integration as part
...
class CinderVolumeIbmgpfsOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Ibmgpfs Operator charm."""

    service_name = "cinder-volume-ibmgpfs"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for IBM GPFS."""
        return "ibmgpfs." + self.model.app.name
    ...
    def _configuration_type_overrides(self) -> dict[str, typing.Any]:
        ...
        overrides.update(
            {
                "gpfs-images-share-mode": ImagesShareMode | None,
                "gpfs-user-password": typing.Annotated[
                    str,
                    pydantic.BeforeValidator(sunbeam_storage.secret_validator("gpfs-user-password")),
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeIbmgpfsOperatorCharm)
