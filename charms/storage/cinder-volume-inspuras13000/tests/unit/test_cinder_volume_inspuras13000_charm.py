...
"""Unit tests for Cinder AS13000 operator charm."""
...
class _CinderVolumeInspuras13000OperatorCharm(charm.CinderVolumeInspuras13000OperatorCharm):
...
class TestCinderInspuras13000OperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeInspuras13000OperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeInspuras13000OperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        secret = self.harness.add_user_secret({"as13000-token-available-time": "test-value"})
        ...
        self.harness.update_config(
            {"san-ip": "10.20.20.3", "as13000-token-available-time": secret}
        )
