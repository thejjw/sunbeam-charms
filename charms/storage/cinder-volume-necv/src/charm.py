...
"""Cinder VStorage FC Operator Charm.

This charm provide Cinder <-> VStorage FC integration as part
...
class CinderVolumeNecvOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/VStorage FC Operator charm."""

    service_name = "cinder-volume-necv"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for NEC VStorage."""
        return "necv." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeNecvOperatorCharm)
