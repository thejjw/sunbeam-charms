...
"""Unit tests for Cinder VStorage FC operator charm."""
...
class _CinderVolumeNecvOperatorCharm(charm.CinderVolumeNecvOperatorCharm):
...
class TestCinderNecvOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeNecvOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeNecvOperatorCharm,
            "_import_snap",
