...
"""Cinder huawei Operator Charm.

This charm provide Cinder <-> huawei integration as part
...
class CinderVolumeHuaweiOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Huawei Operator charm."""

    service_name = "cinder-volume-huawei"

    @property
    def backend_key(self) -> str:
        return "huawei." + self.model.app.name
        ...
        overrides.update(
            {
                ...
                "metro-san-password": typing.Annotated[
                    str,
                    pydantic.BeforeValidator(sunbeam_storage.secret_validator("metro-san-password")),
                ],
            }
        )
        return overrides
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeHuaweiOperatorCharm)
