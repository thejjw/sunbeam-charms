...
"""Unit tests for Cinder Hitachi operator charm class."""
...
class TestCinderHitachiOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderHitachiOperatorCharm class."""
    ...
    def test_all_relations(self):
        ...
        san_secret = self.harness.add_user_secret(
            {"san-username": "admin", "san-password": "secret"}
        )
        add_complete_cinder_volume_relation(self.harness)
        self.harness.grant_secret(san_secret, self.harness.charm.app)
        self.harness.update_config(
            {
                "san-ip": "10.20.20.3",
                "san-username": san_secret,
