...
"""Unit tests for Cinder zadara operator charm."""
...
class _CinderVolumeZadaraOperatorCharm(charm.CinderVolumeZadaraOperatorCharm):
...
class TestCinderZadaraOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeZadaraOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeZadaraOperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        secret = self.harness.add_user_secret({"zadara-access-key": "test-value"})
