...
"""Unit tests for Cinder ibmflashsystemiscsi operator charm."""
...
class _CinderVolumeIbmflashsystemiscsiOperatorCharm(charm.CinderVolumeIbmflashsystemiscsiOperatorCharm):
...
class TestCinderIbmflashsystemiscsiOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeIbmflashsystemiscsiOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeIbmflashsystemiscsiOperatorCharm,
            "_import_snap",
