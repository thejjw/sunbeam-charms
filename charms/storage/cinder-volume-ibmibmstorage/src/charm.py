...
"""Cinder ibmibmstorage Operator Charm.

This charm provide Cinder <-> ibmibmstorage integration as part
...
class CinderVolumeIbmibmstorageOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Ibmibmstorage Operator charm."""

    service_name = "cinder-volume-ibmibmstorage"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for IBM IBMStorage."""
        return "ibmibmstorage." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeIbmibmstorageOperatorCharm)
