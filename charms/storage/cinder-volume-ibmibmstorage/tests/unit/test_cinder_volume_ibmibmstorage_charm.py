...
"""Unit tests for Cinder ibmibmstorage operator charm."""
...
class _CinderVolumeIbmibmstorageOperatorCharm(charm.CinderVolumeIbmibmstorageOperatorCharm):
...
class TestCinderIbmibmstorageOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeIbmibmstorageOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeIbmibmstorageOperatorCharm,
            "_import_snap",
