...
"""Cinder nimble Operator Charm.

This charm provide Cinder <-> nimble integration as part
...
class CinderVolumeNimbleOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Nimble Operator charm."""

    service_name = "cinder-volume-nimble"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for Nimble."""
        return "nimble." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeNimbleOperatorCharm)
