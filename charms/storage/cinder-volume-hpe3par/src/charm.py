...
"""Cinder Hpe 3Par Operator Charm.

This charm provide Cinder <-> Hpe 3Par integration as part
...
class CinderVolumeHpethreeparOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Hpethreepar Operator charm."""

    service_name = "cinder-volume-hpe3par"
        ...
        overrides.update(
            {
                ...
                "hpe3par-password": typing.Annotated[
                    str,
                    pydantic.BeforeValidator(sunbeam_storage.secret_validator("hpe3par-password")),
                ],
                "hpe3par-iscsi-ips": CIDR_LIST_TYPING,
            }
        )
        return overrides
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeHpethreeparOperatorCharm)
