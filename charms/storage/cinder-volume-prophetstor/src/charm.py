...
"""Cinder prophetstor Operator Charm.

This charm provide Cinder <-> prophetstor integration as part
...
class CinderVolumeProphetstorOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Prophetstor Operator charm."""

    service_name = "cinder-volume-prophetstor"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for ProphetStor."""
        return "prophetstor." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeProphetstorOperatorCharm)
