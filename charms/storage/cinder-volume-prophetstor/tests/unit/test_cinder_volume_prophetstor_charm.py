...
"""Unit tests for Cinder prophetstor operator charm."""
...
class _CinderVolumeProphetstorOperatorCharm(charm.CinderVolumeProphetstorOperatorCharm):
...
class TestCinderProphetstorOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeProphetstorOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeProphetstorOperatorCharm,
            "_import_snap",
