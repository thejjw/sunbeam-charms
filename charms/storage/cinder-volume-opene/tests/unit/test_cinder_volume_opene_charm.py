...
"""Unit tests for Cinder opene operator charm."""
...
class _CinderVolumeOpeneOperatorCharm(charm.CinderVolumeOpeneOperatorCharm):
...
class TestCinderOpeneOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeOpeneOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeOpeneOperatorCharm,
            "_import_snap",
