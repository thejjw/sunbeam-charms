...
"""Unit tests for Cinder dellunity operator charm."""
...
class _CinderVolumeDellunityOperatorCharm(charm.CinderVolumeDellunityOperatorCharm):
...
class TestCinderDellunityOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeDellunityOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeDellunityOperatorCharm,
            "_import_snap",
