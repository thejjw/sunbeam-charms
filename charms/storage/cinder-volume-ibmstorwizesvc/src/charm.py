...
"""Cinder ibmstorwizesvc Operator Charm.

This charm provide Cinder <-> ibmstorwizesvc integration as part
...
class CinderVolumeIbmstorwizesvcOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Ibmstorwizesvc Operator charm."""

    service_name = "cinder-volume-ibmstorwizesvc"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for IBM Storwize SVC."""
        return "ibmstorwizesvc." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeIbmstorwizesvcOperatorCharm)
