...
"""Unit tests for Cinder ibmstorwizesvc operator charm."""
...
class _CinderVolumeIbmstorwizesvcOperatorCharm(charm.CinderVolumeIbmstorwizesvcOperatorCharm):
...
class TestCinderIbmstorwizesvcOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeIbmstorwizesvcOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeIbmstorwizesvcOperatorCharm,
            "_import_snap",
