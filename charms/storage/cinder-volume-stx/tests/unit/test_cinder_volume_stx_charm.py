...
"""Unit tests for Cinder stx operator charm."""
...
class _CinderVolumeStxOperatorCharm(charm.CinderVolumeStxOperatorCharm):
...
class TestCinderStxOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeStxOperatorCharm class."""
