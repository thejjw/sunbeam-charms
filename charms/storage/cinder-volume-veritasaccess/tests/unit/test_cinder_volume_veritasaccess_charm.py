...
"""Unit tests for Cinder veritasaccess operator charm."""
...
class _CinderVolumeVeritasaccessOperatorCharm(charm.CinderVolumeVeritasaccessOperatorCharm):
...
class TestCinderVeritasaccessOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeVeritasaccessOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeVeritasaccessOperatorCharm,
            "_import_snap",
