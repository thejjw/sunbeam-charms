...
"""Unit tests for Cinder solidfire operator charm."""
...
class _CinderVolumeSolidFireOperatorCharm(charm.CinderVolumeSolidFireOperatorCharm):
...
class TestCinderSolidFireOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeSolidFireOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeSolidFireOperatorCharm,
            "_import_snap",
