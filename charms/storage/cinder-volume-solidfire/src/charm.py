...
"""Cinder solidfire Operator Charm.

This charm provide Cinder <-> solidfire integration as part
...
class CinderVolumeSolidFireOperatorCharm(
    charm.OSCinderVolumeDriverOperatorCharm
):
    """Cinder/SolidFire Operator charm."""

    service_name = "cinder-volume-solidfire"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for SolidFire."""
        return "solidfire." + self.model.app.name

    def _configuration_type_overrides(self) -> dict[str, typing.Any]:
        overrides = super()._configuration_type_overrides()
        overrides.update(
            {
                "sf-provisioning-calc": ProvisioningCalc | None,
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeSolidFireOperatorCharm)
