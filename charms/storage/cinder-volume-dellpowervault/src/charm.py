...
"""Cinder dellpowervault Operator Charm.

This charm provide Cinder <-> dellpowervault integration as part
...
class CinderVolumeDellpowervaultOperatorCharm(
    charm.OSCinderVolumeDriverOperatorCharm
):
    """Cinder/Dellpowervault Operator charm."""

    service_name = "cinder-volume-dellpowervault"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for Dell PowerVault."""
        return "dellpowervault." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeDellpowervaultOperatorCharm)
