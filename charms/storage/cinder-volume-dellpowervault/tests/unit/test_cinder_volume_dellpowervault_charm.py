...
"""Unit tests for Cinder dellpowervault operator charm."""
...
class _CinderVolumeDellpowervaultOperatorCharm(
    charm.CinderVolumeDellpowervaultOperatorCharm
):
...
class TestCinderDellpowervaultOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeDellpowervaultOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeDellpowervaultOperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        self.harness.update_config({"san-ip": "10.20.20.3", "protocol": "fc"})
