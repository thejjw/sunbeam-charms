...
"""Cinder dellpowerflex Operator Charm.

This charm provide Cinder <-> dellpowerflex integration as part
...
class CinderVolumeDellpowerflexOperatorCharm(
    charm.OSCinderVolumeDriverOperatorCharm
):
    """Cinder/Dell PowerFlex Operator charm."""

    service_name = "cinder-volume-dellpowerflex"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for Dell PowerFlex."""
        return "dellpowerflex." + self.model.app.name
        ...
        overrides.update(
            {
                ...
                "protocol": typing.Annotated[
                    typing.Literal["scaleio", "nvme-tcp"],
                    sunbeam_storage.Required,
                ],
            }
        )
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeDellpowerflexOperatorCharm)
