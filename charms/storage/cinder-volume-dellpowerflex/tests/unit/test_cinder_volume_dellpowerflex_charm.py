...
"""Unit tests for Cinder dell operator charm."""
...
class _CinderVolumeDellpowerflexOperatorCharm(charm.CinderVolumeDellpowerflexOperatorCharm):
...
class TestCinderDellpowerflexOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeDellpowerflexOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeDellpowerflexOperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        san_login_secret = self.harness.add_user_secret({"san-login": "test-login"})
        san_password_secret = self.harness.add_user_secret({"san-password": "test-password"})
        ...
        self.harness.update_config(
            {"san-ip": "10.20.20.3", "san-login": san_login_secret, "san-password": san_password_secret}
        )
