...
class _CinderVolumeDellOperatorCharm(charm.CinderVolumeDellOperatorCharm):
...
class TestCinderDellOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeDellOperatorCharm class."""
