...
"""Unit tests for Cinder inspurinstorage operator charm."""
...
class _CinderVolumeInspurinstorageOperatorCharm(charm.CinderVolumeInspurinstorageOperatorCharm):
...
class TestCinderInspurinstorageOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeInspurinstorageOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeInspurinstorageOperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        self.harness.update_config(
            {"san-ip": "192.168.1.100", "san-login": secret_login, "san-password": secret_password}
        )
