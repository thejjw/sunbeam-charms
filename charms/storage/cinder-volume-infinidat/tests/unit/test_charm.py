...
"""Unit tests for Cinder Infinidat operator charm class."""
...
class _CinderVolumeInfinidatOperatorCharm(
    charm.CinderVolumeInfinidatOperatorCharm
):
...
class TestCinderInfinidatOperatorCharm(test_utils.CharmTestCase):
    ...
    def test_all_relations(self):
        ...
        san_login_secret = self.harness.add_user_secret({"san-login": "admin"})
        san_password_secret = self.harness.add_user_secret(
            {"san-password": "secret123"}
        )
