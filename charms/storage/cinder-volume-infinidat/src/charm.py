        ...
        overrides.update(
            {
                ...
                "san-ip": typing.Annotated[str, sunbeam_storage.Required],
                "infinidat-pool-name": typing.Annotated[
                    str, sunbeam_storage.Required
                ],
                "infinidat-iscsi-netspaces": typing.Optional[str],
