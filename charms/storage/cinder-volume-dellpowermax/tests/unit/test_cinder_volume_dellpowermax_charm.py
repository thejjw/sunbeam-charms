...
"""Unit tests for Cinder Dell PowerMax operator charm."""
...
class _CinderVolumeDellpowermaxOperatorCharm(charm.CinderVolumeDellpowermaxOperatorCharm):
...
class TestCinderDellpowermaxOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeDellpowermaxOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeDellpowermaxOperatorCharm,
            "_import_snap",
