...
"""Cinder dellpowermax Operator Charm.

This charm provide Cinder <-> dellpowermax integration as part
...
class CinderVolumeDellpowermaxOperatorCharm(
    charm.OSCinderVolumeDriverOperatorCharm
):
    """Cinder/Dell PowerMax Operator charm."""

    service_name = "cinder-volume-dellpowermax"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for Dell PowerMax."""
        return "dellpowermax." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeDellpowermaxOperatorCharm)
