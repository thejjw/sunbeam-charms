...
"""Unit tests for Cinder linstor operator charm."""
...
class _CinderVolumeLinstorOperatorCharm(charm.CinderVolumeLinstorOperatorCharm):
...
class TestCinderLinstorOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeLinstorOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeLinstorOperatorCharm,
            "_import_snap",
