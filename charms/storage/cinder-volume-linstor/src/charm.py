...
class CinderVolumeLinstorOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Linstor Operator charm."""

    service_name = "cinder-volume-linstor"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for LINSTOR."""
        return "linstor." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeLinstorOperatorCharm)
