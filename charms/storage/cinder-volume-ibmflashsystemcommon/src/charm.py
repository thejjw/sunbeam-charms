...
"""Cinder ibmflashsystemcommon Operator Charm.

This charm provide Cinder <-> ibmflashsystemcommon integration as part
...
class CinderVolumeIbmflashsystemcommonOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Ibmflashsystemcommon Operator charm."""

    service_name = "cinder-volume-ibmflashsystemcommon"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for IBM FlashSystem Common."""
        return "ibmflashsystemcommon." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeIbmflashsystemcommonOperatorCharm)
