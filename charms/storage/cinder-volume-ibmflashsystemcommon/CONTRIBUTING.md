...
Ibmflashsystemcommon storage array as a Cinder
backend in a Sunbeam OpenStack deployment.

```bash
juju deploy cinder-volume
juju deploy cinder-volume-ibmflashsystemcommon --trust
juju relate cinder-volume-ibmflashsystemcommon cinder-volume
```
