...
"""Unit tests for Cinder ibmflashsystemcommon operator charm."""
...
class _CinderVolumeIbmflashsystemcommonOperatorCharm(charm.CinderVolumeIbmflashsystemcommonOperatorCharm):
...
class TestCinderIbmflashsystemcommonOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeIbmflashsystemcommonOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeIbmflashsystemcommonOperatorCharm,
            "_import_snap",
