...
"""Unit tests for Cinder yadro operator charm."""
...
class _CinderVolumeYadroOperatorCharm(charm.CinderVolumeYadroOperatorCharm):
...
class TestCinderYadroOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeYadroOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeYadroOperatorCharm,
            "_import_snap",
