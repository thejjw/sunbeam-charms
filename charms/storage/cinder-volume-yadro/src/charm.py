...
"""Cinder yadro Operator Charm.

This charm provide Cinder <-> yadro integration as part
...
class CinderVolumeYadroOperatorCharm(charm.OSCinderVolumeDriverOperatorCharm):
    """Cinder/Yadro Operator charm."""

    service_name = "cinder-volume-yadro"

    @property
    def backend_key(self) -> str:
        """Return the Cinder backend section key for YADRO Tatlin."""
        return "yadro." + self.model.app.name
...
if __name__ == "__main__":  # pragma: nocover
    ops.main(CinderVolumeYadroOperatorCharm)
