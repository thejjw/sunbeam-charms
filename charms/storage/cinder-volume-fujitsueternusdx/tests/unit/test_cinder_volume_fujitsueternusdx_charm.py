...
"""Unit tests for Cinder fujitsueternusdx operator charm."""
...
class _CinderVolumeFujitsueternusdxOperatorCharm(charm.CinderVolumeFujitsueternusdxOperatorCharm):
...
class TestCinderFujitsueternusdxOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeFujitsueternusdxOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeFujitsueternusdxOperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        secret = self.harness.add_user_secret({"fujitsu-passwordless": "test-value"})
        ...
        self.harness.update_config(
            {"san-ip": "10.20.20.3", "fujitsu-passwordless": secret}
        )
