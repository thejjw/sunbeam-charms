...
"""Unit tests for Cinder nexenta operator charm."""
...
class _CinderVolumeNexentaOperatorCharm(charm.CinderVolumeNexentaOperatorCharm):
...
class TestCinderNexentaOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderVolumeNexentaOperatorCharm class."""
    ...
    def setUp(self):
        ...
        snap_patch = patch.object(
            _CinderVolumeNexentaOperatorCharm,
            "_import_snap",
    ...
    def test_all_relations(self):
        ...
        secret = self.harness.add_user_secret({"nexenta-rest-password": "test-value"})
