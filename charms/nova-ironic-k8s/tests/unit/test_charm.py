...
"""Unit tests for the nova-compute service for Ironic K8s charm."""
...
class _NovaIronicOperatorCharm(charm.NovaIronicOperatorCharm):
    """Test implementation of nova-ironic-k8s operator."""
...
class TestNovaIronicOperatorCharm(test_utils.CharmTestCase):
    """Unit tests for nova-compute service for Ironic Operator."""
    ...
    def setUp(self):
        ...
        self.harness = test_utils.get_harness(
            _NovaIronicOperatorCharm, container_calls=self.container_calls
        )
    ...
    def add_ironic_api_relation(self, harness: Harness) -> None:
    ...
    def test_pebble_ready_handler(self):
        ...
        self.harness.container_pebble_ready("nova-ironic")
    ...
    def test_all_relations(self):
        ...
        self.add_ironic_api_relation(self.harness)

        self.check_file("nova-ironic", "/etc/nova/nova.conf")
        config_files = [
            "/etc/nova/nova.conf",
            "/etc/nova/rootwrap.conf",
        ]
        for f in config_files:
            self.check_file("nova-ironic", f)
