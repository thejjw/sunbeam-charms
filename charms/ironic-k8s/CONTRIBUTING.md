...
To deploy the local test instance:
    ...
    juju deploy ./ironic-k8s.charm ironic --trust \
      --resource ironic-api-image=ghcr.io/canonical/ironic-api:2026.1-26.04_edge \
      --resource ironic-novncproxy-image=ghcr.io/canonical/ironic-novncproxy:2026.1-26.04_edge
