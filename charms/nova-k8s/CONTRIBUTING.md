...
To deploy the local test instance:
    ...
    juju deploy ./nova-k8s_ubuntu-20.04-amd64.charm --trust --resource nova-api-image=ghcr.io/canonical/nova-api:2026.1 --resource nova-scheduler-image=ghcr.io/canonical/nova-scheduler:2026.1 --resource nova-conductor-image=ghcr.io/canonical/nova-conductor:2026.1-26.04_edge
