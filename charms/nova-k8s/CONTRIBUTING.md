...
To deploy the local test instance:
    ...
    juju deploy ./nova-k8s_ubuntu-20.04-amd64.charm --trust --resource nova-api-image=ghcr.io/canonical/nova-consolidated:2026.2-26.04_edge --resource nova-scheduler-image=ghcr.io/canonical/nova-consolidated:2026.2-26.04_edge --resource nova-conductor-image=ghcr.io/canonical/nova-consolidated:2026.2-26.04_edge
